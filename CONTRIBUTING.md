...
* *Do* fetch upstream (`rlworkgroup/metarl`) frequently and keep your `master` branch up-to-date with upstream
...
cd metarl
git remote add rlworkgroup git@github.com:rlworkgroup/metarl.git
...
### Modify CHANGELOG.md
For each release in metarl, modify [CHANGELOG.md](https://github.com/rlworkgroup/metarl/blob/master/CHANGELOG.md) with the most relevant changes from the latest release. The format is based on [Keep a Changelog](https://keepachangelog.com/en/1.0.0/), which adheres to [Semantic Versioning](https://semver.org/spec/v2.0.0.html).
