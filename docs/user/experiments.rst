...
In metarl, experiments are described using Python files we call "experiment
...
The metarl repository contains several example experiment launchers. A fairly
...
.. code-block:: text
  ...
  2020-05-11 14:13:05 | [trpo_cartpole] Logging to /home/kr/metarl/data/local/experiment/trpo_cartpole_1
...
.. code-block:: text
  ...
  >>> print(metarl.wrap_experiment.__doc__)
