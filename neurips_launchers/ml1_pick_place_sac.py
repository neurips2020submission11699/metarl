...
def ml1_pick_place_v1_sac(ctxt=None, seed=1):
    """Set up environment and algorithm and run the task."""
    runner = LocalRunner(ctxt)
    Ml1_reach_envs = get_ML1_envs("reach-v1")
    Ml1_reach_test_envs = get_ML1_envs_test("reach-v1")
...
ml1_pick_place_v1_sac(seed=532)
