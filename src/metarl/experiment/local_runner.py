"""Provides algorithms with access to most of metarl's features."""
import copy
import os
import time
...
from metarl.experiment.deterministic import get_seed, set_seed
from metarl.experiment.snapshotter import Snapshotter
from metarl.sampler import parallel_sampler
from metarl.sampler.sampler_deprecated import BaseSampler
# This is avoiding a circular import
from metarl.sampler.default_worker import DefaultWorker  # noqa: I100
...
class LocalRunner:
    ...
    def _start_worker(self):
        ...
        if self._plot:
            ...
            from metarl.plotter import Plotter
    ...
    def step_epochs(self):
        ...
        n_epochs = int(
            os.environ.get('METARL_EXAMPLE_TEST_N_EPOCHS',
    ...
    def get_env_copy(self):
        ...
        Returns:
            metarl.envs.MetaRLEnv: An environement instance.
