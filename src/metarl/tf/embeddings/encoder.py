...
from metarl.np.embeddings import Encoder as BaseEncoder
from metarl.np.embeddings import StochasticEncoder as BaseStochasticEncoder
from metarl.tf.models import Module, StochasticModule
...
class Encoder(BaseEncoder, Module):
    ...
    def clone(self, name):
        ...
        Returns:
            metarl.tf.embeddings.encoder.Encoder: Newly cloned encoder.
