...
class GaussianMLPTaskEmbeddingPolicy(TaskEmbeddingPolicy):
    ...
    Args:
        ...
        encoder (metarl.tf.embeddings.StochasticEncoder): Embedding network.
    ...
    def _initialize(self):
        ...
        with tf.compat.v1.variable_scope(self.name) as vs:
            ...
            dist_given_latent, _, _ = self.model.build(
                obs_latent_input,
    ...
    def clone(self, name):
        ...
        Returns:
            metarl.tf.policies.GaussianMLPTaskEmbeddingPolicy: Cloned policy.
