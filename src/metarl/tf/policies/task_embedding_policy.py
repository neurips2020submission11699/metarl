...
from metarl.tf.policies.policy import StochasticPolicy
...
class TaskEmbeddingPolicy(StochasticPolicy):
    ...
    Args:
        ...
        encoder (metarl.tf.embeddings.StochasticEncoder):
    ...
    @property
    def encoder(self):
        """metarl.tf.embeddings.encoder.Encoder: Encoder."""
    ...
    def encoder_distribution(self):
        """metarl.tf.distributions.DiagonalGaussian: Encoder distribution."""
