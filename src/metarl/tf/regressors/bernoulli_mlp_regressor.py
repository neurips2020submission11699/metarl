...
from metarl import make_optimizer
from metarl.tf.distributions import Bernoulli
from metarl.tf.misc import tensor_utils
from metarl.tf.models import NormalizedInputMLPModel
from metarl.tf.optimizers import ConjugateGradientOptimizer, LbfgsOptimizer
from metarl.tf.regressors.regressor import StochasticRegressor
...
class BernoulliMLPRegressor(StochasticRegressor):
    ...
    Args:
        ...
        output_b_init (Callable): Initializer function for the bias
            of output dense layer(s). The function should return a
            tf.Tensor. Default is zero initializer.
        optimizer (metarl.tf.Optimizer): Optimizer for minimizing the negative
        ...
        tr_optimizer (metarl.tf.Optimizer): Optimizer for trust region
    ...
    def distribution(self):
        """metarl.tf.distributions.DiagonalGaussian: Distribution."""
