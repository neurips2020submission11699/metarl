...
from metarl.sampler import Worker
...
class TFWorkerWrapper(Worker):
    ...
    def agent(self):
        ...
        Returns:
            metarl.Policy: the worker's agent.
    ...
    def rollout(self):
        ...
        Returns:
            metarl.TrajectoryBatch: Batch of sampled trajectories. May be
