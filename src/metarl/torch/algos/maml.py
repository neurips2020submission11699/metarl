...
from metarl.torch import update_module_params
from metarl.torch.optimizers import ConjugateGradientOptimizer
from metarl.torch.optimizers import DifferentiableSGD
...
class MAML:
    ...
    Args:
        inner_algo (metarl.torch.algos.VPG): The inner algorithm used for
            computing loss.
        env (metarl.envs.MetaRLEnv): A gym environment.
        policy (metarl.torch.policies.Policy): Policy.
        ...
        meta_evaluator (metarl.experiment.MetaEvaluator): A meta evaluator for
    ...
    def policy(self):
        ...
        Returns:
            metarl.torch.policies.Policy: Current policy of the inner
                algorithm.
    ...
    def _old_policy(self):
        ...
        Returns:
            metarl.torch.policies.Policy: Old policy of the inner algorithm.
