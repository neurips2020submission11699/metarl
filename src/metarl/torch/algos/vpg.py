...
from metarl.torch import (compute_advantages, filter_valids, pad_to_last)
...
class VPG(RLAlgorithm):
    ...
    Args:
        ...
        value_function (metarl.torch.value_functions.ValueFunction): The value
            function.
        policy_optimizer (metarl.torch.optimizer.OptimizerWrapper): Optimizer
            for policy.
        vf_optimizer (metarl.torch.optimizer.OptimizerWrapper): Optimizer for
            value function.
