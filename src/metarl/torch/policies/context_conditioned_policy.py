...
from metarl.torch import global_device, product_of_gaussians
...
class ContextConditionedPolicy(nn.Module):
    ...
    Args:
        ...
        context_encoder (metarl.torch.embeddings.ContextEncoder): Recurrent or
            permutation-invariant context encoder.
        policy (metarl.torch.policies.Policy): Policy used to train the
            network.
