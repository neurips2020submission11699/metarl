"""
This script creates a test that tests functions in metarl.misc.tensor_utils.
"""

import numpy as np

from metarl.envs import MetaRLEnv
from metarl.misc.tensor_utils import concat_tensor_dict_list
from metarl.misc.tensor_utils import explained_variance_1d
from metarl.misc.tensor_utils import normalize_pixel_batch
from metarl.misc.tensor_utils import pad_tensor
from metarl.misc.tensor_utils import stack_and_pad_tensor_dict_list
from metarl.misc.tensor_utils import stack_tensor_dict_list
