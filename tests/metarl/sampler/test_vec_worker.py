...
from metarl.envs import GridWorldEnv
from metarl.experiment.task_sampler import EnvPoolSampler
from metarl.np.policies import ScriptedPolicy
from metarl.sampler import LocalSampler, VecWorker, WorkerFactory
...
@pytest.fixture
def env():
    return MetaRLEnv(GridWorldEnv(desc='4x4'))
...
def envs():
    ...
    return [MetaRLEnv(GridWorldEnv(desc=desc)) for desc in descs]
