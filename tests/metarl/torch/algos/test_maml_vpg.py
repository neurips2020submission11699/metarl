...
try:
    ...
    pytest.skip('To use mujoco-based features, please install metarl[mujoco].',
...
from metarl.envs.mujoco import HalfCheetahDirEnv
from metarl.experiment import deterministic, LocalRunner, MetaEvaluator
